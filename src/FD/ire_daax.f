      subroutine ire_daax(n_DDLthetatheta,n_DDLxx,n_JSthth,n_JSxx,n_Pxx,
     &n_RRthetatheta,n_RRxx,n_Uxx,n_alpha,n_em4phi,n_metthetatheta,n_met
     &xx,nm1_Axx,np1_Axx,Nx,ht,res)
      implicit none
      integer i
      integer Nx
      real*8 ht
